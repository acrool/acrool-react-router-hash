...
- Create an [issue](https://github.com/acrool/acrool-react-router-hash/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/acrool/acrool-react-router-hash/issues), assuming one does not already exist.
